    ...
    PolicyDocument=Policy(
        ...
        Statement=[
            Statement(
                Action=[PutObject],
                Effect=Allow,
                Principal=Principal("AWS", ["054676820928"]),
                Resource=[Join('',
                               [ARN(''),
                                Ref("S3Bucket"),
                                   "/AWSLogs/62605676694/*"])],
...
t.add_resource(Alarm(
    ...
    AlarmActions=["arn:aws:sns:eu-central-1:762605676694:alert-email"],
    OKActions=["arn:aws:sns:eu-central-1:762605676694:alert-email"],
